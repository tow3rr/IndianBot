...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
    "`Ciao questa è la gui del mio capo\n\n`"
    "`Aspetta che verrai approvato.`"
    "`Non floddare o verrai bloccato automaticamente.\n\n`"
    "`Porta pazienza il mio capo ti risponderà il prima possibile!`")
# =================================================================


@register(incoming=True, disable_edited=True, disable_errors=True)
async def permitpm(event):
    """ Proibisce di farti spammare in dm. \
